...
const selectDay = async () => {
  await sleep(1000); // I know that sleeps() are an automation CRIME but this is a hack project please excuse me 🙏
  ...
  await sleep(5000); // I know that sleeps() are the an automation CRIME but this is a hack project please excuse me 🙏
}
